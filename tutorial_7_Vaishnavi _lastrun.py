...
expName = 'tutorial_7_Vaishnavi '  # from the Builder filename that created this script
expInfo = {
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/vaishnavipatel/Downloads/tutorial_7_Vaishnavi _lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    # --- Initialize components for Routine "beep_sound_" ---
    ...
    trials = data.TrialHandler(nReps=100.0, method='random', 
        ...
        trialList=data.importConditions('ib_cons - Sheet1.csv'),
    ...
    for thisTrial in trials:
        ...
        # --- Prepare to start Routine "beep_sound_" ---
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('beep_sound_.started', globalClock.getTime())
        sound_1.setSound(freq, secs=0.3, hamming=True)
        sound_1.setVolume(1.0, log=False)
        sound_1.seek(0)
        # keep track of which components have finished
        beep_sound_Components = [sound_1]
        for thisComponent in beep_sound_Components:
        ...
        # --- Ending Routine "beep_sound_" ---
        for thisComponent in beep_sound_Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('beep_sound_.stopped', globalClock.getTime())
        sound_1.pause()  # ensure sound has stopped at end of Routine
        # the Routine "beep_sound_" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        ...
        # keep track of which components have finished
        responsesComponents = [text, textbox, mouse, text_2]
